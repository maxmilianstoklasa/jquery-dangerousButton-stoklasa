...
$(function () {
    ...
    */
     ...
     */
    $(".btn-danger").on("click", () => {
        $("strong").css("border", "4px solid red");
        $(".datum").slideUp(2000).show(2000);
        //$("h3").animate({height: "200px"}, 2000); 
        $("h2").animate({ height: "100px", width: "300px" }, 2000);
        $("h1").animate({ height: "400px" }, 2000);
        $('input[type="text"]').css("background", "red");
        let copy = $("#nazevASymboly .nazev");
        $("#nazevASymboly .symboly").text(copy.text());
        $(".symboly").append("<strong><i>Já sloužím zde jen proto, abych se alespoň trochu textově odlišil od mého souseda nademnou.<i><strong>");
        //$("a Maxmilián Stoklasa").appendTo("p .autor");
        $("#narod").replaceWith("<div><strong>Nic nezjistíš!<strong></div>");
